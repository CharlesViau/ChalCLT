...
public class PignonDroitFiniSTL extends Forme {
    public PignonDroitFiniSTL(double x, double y, double z, double width, double thickness, Direction facingDirection, double theta, double alpha, double beta, double gamma){
        this.x = x;
        this.y = y;
        this.z = z;
        this.width = width;
    ...
    public String writer() {
        ...
        double petitHeight = tan(theta)*(width-thickness)+thickness/2-tan(theta)*thickness;
        double[][] vecteur= {
                ...
                {0,0,thickness/2,thickness/2,0,0,-thickness/2,-thickness/2,
                ...
                {0,thickness/2,thickness/2,0,0,thickness/2,thickness/2,0,
                        ...
                        grandeHeight,grandeHeight,petitHeight,petitHeight
